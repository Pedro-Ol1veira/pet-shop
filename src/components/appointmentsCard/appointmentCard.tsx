...
import { AppointmentForm } from "../appointmetnForm/appointmetnForm";
...
export const AppointmentCard = ({ appointment, isFirstInSection = false }: AppointmentCardProps) => {
        ...
        <div
            ...
            <div className="text-right md:text-left md:pr-4">
                <div className="flex items-center justify-end md:justify-start gap-1">
                    ...
                    <span className="text-paragraph-small-size text-content-secondary">{appointment.tutorName}</span>
                </div>
            </div>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Tem certeza que deseja remover esse agendamento? Esta ação não pode ser desfeita.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel>
